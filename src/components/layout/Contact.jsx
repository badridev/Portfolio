...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 px-6">
      {/* Section Title */}
      <h2 className="text-4xl font-bold text-center text-[#ffa800] mb-20">
        Contact
      </h2>

      <div
        className={`container mx-auto flex flex-col items-center space-y-12
                    ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}
                    transition-all duration-700`}
      >
        {/* Find Me Card */}
        <div className="w-full max-w-5xl h-80 bg-gray-900/70 p-12 rounded-3xl shadow-lg border-2 border-[#ffa800] 
        ...
        {/* Contact Form */}
        <div className="w-full max-w-5xl h-auto bg-gray-900/70 p-12 rounded-3xl shadow-lg border-2 border-[#ffa800] 
